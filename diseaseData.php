...
$sql="select disease, dis_symptoms, dis_discription, treatment, doctor from tbl_dis_data 
       where disease='$disease'";
$resultt=mysql_query($sql) or die("Query to get data from firsttable failed with this error: ".mysql_error());
